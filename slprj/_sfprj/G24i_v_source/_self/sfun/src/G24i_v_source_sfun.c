  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==2) {
    c2_G24i_v_source_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
       ...
       case 2:
        {
          ...
          sf_c2_G24i_v_source_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3456174243U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4108178802U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1477353584U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3008228674U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "M88p02g4jGMl303L36SSYF") == 0) {
          extern mxArray *sf_c2_G24i_v_source_get_autoinheritance_info(void);
          plhs[0] = sf_c2_G24i_v_source_get_autoinheritance_info();
          break;
        }
     ...
     case 2:
      {
        extern const mxArray
          *sf_c2_G24i_v_source_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_G24i_v_source_get_eml_resolved_functions_info();
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "4aYqFQfyQqQTkpUUgOJxBD") == 0) {
          extern mxArray *sf_c2_G24i_v_source_third_party_uses_info(void);
          plhs[0] = sf_c2_G24i_v_source_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "4aYqFQfyQqQTkpUUgOJxBD") == 0) {
          extern mxArray *sf_c2_G24i_v_source_updateBuildInfo_args_info(void);
          plhs[0] = sf_c2_G24i_v_source_updateBuildInfo_args_info();
          break;
        }
      }
