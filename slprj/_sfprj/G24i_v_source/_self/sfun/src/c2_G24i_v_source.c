...
static const char * c2_debug_family_names[14] = { "Dinit", "Dmax", "Dmin",
  "deltaD", "dataType", "Vmpp", "nargin", "nargout", "Param", "Enabled", "V",
  "V_oc", "D", "Dold" };
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_G24i_v_sourceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_G24i_v_sourceInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_G24i_v_source, const char_T
  *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_G24i_v_sourceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  (SFc2_G24i_v_sourceInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_G24i_v_source;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_D = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
    "D");
  chartInstance->c2_Dold = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "Dold");
  chartInstance->c2_is_active_c2_G24i_v_source = c2_g_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T *c2_b_V_oc;
  real_T (*c2_b_Param)[4];
  c2_b_V_oc = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c2_V_oc = c2_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Dinit, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Dmax, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Dmin, 2U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltaD, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_dataType, 4U, c2_d_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Vmpp, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 7U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_Param, 8U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Enabled, 9U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_V, 10U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_V_oc, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_D, 12U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c2_Dold, 13U,
  ...
  for (c2_i2 = 0; c2_i2 < 6; c2_i2++) {
    c2_dataType[c2_i2] = c2_cv0[c2_i2];
  }
  ...
  *c2_b_D = c2_D;
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_V_oc, 4U);
}
  ...
  *chartInstance, const mxArray *c2_D, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_D), &c2_thisId);
  sf_mex_destroy(&c2_D);
  return c2_y;
}
  ...
  *c2_inData)
{
  ...
  for (c2_i5 = 0; c2_i5 < 6; c2_i5++) {
    c2_b_inData[c2_i5] = (*(char_T (*)[6])c2_inData)[c2_i5];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_dataType), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_dataType);
  for (c2_i8 = 0; c2_i8 < 6; c2_i8++) {
    (*(char_T (*)[6])c2_outData)[c2_i8] = c2_y[c2_i8];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1524919015U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(310703225U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1023530180U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(450685883U);
}
...
mxArray *sf_c2_G24i_v_source_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("p1KuyPaDtNVSB4Jx5oxiv");
...
static const mxArray *sf_get_sim_state_info_c2_G24i_v_source(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"D\",},{M[4],M[0],T\"Dold\",S'l','i','p'{{M1x2[559 563],M[0],}}},{M[8],M[0],T\"is_active_c2_G24i_v_source\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(4,1,1,0,"V_oc");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,715);
        _SFD_CV_INIT_EML_IF(0,1,0,588,604,-1,626);
        _SFD_CV_INIT_EML_IF(0,1,1,635,650,-1,703);
...

        {
          ...
          real_T *c2_V_oc;
          real_T (*c2_Param)[4];
          c2_V_oc = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, c2_V_oc);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_G24i_v_source(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2657644502U));
  ssSetChecksum1(S,(3999966148U));
  ssSetChecksum2(S,(303975323U));
  ssSetChecksum3(S,(3170433397U));
