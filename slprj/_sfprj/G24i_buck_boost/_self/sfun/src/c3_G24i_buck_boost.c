...
static void initialize_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
static void initialize_params_c3_G24i_buck_boost
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance);
static void enable_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
static void disable_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_G24i_buck_boost
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_G24i_buck_boost
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance);
static void set_sim_state_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct *
  chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_G24i_buck_boost
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance);
static void finalize_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
static void sf_gateway_c3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
static void initSimStructsc3_G24i_buck_boost(SFc3_G24i_buck_boostInstanceStruct *
  chartInstance);
static void c3_Sample_and_call(SFc3_G24i_buck_boostInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_c_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_b_tp_init, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_h_emlrt_marshallIn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex, uint32_T c3_dataNumber);
static void init_dsm_address_info(SFc3_G24i_buck_boostInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_G24i_buck_boost = 0U;
  chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_G24i_buck_boost == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_G24i_buck_boost == c3_IN_init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_G24i_buck_boost == c3_IN_Sample_and_call) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_G24i_buck_boost == c3_IN_INCREMENT) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_G24i_buck_boost == c3_IN_DECREMENT) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_G24i_buck_boost == c3_IN_RETURN) {
  ...
  (SFc3_G24i_buck_boostInstanceStruct *chartInstance)
{
  ...
  c3_g_hoistedGlobal = chartInstance->c3_is_active_c3_G24i_buck_boost;
  c3_g_u = c3_g_hoistedGlobal;
  c3_h_y = NULL;
  sf_mex_assign(&c3_h_y, sf_mex_create("y", &c3_g_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 6, c3_h_y);
  c3_h_hoistedGlobal = chartInstance->c3_is_c3_G24i_buck_boost;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *c3_v_ref = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
  ...
  chartInstance->c3_is_active_c3_G24i_buck_boost = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 6)),
     "is_active_c3_G24i_buck_boost");
  chartInstance->c3_is_c3_G24i_buck_boost = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 7)), "is_c3_G24i_buck_boost");
  sf_mex_assign(&chartInstance->c3_setSimStateSideEffectsInfo,
                c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 8)), "setSimStateSideEffectsInfo"), true);
  sf_mex_destroy(&c3_u);
  chartInstance->c3_doSetSimStateSideEffects = 1U;
  c3_update_debugger_state_c3_G24i_buck_boost(chartInstance);
  ...
  *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_G24i_buck_boost(chartInstance);
  ...
  if (chartInstance->c3_is_active_c3_G24i_buck_boost == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_G24i_buck_boost = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 12U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_init = 1U;
    ...
    switch (chartInstance->c3_is_c3_G24i_buck_boost) {
     case c3_IN_DECREMENT:
      CV_CHART_EVAL(0, 0, 1);
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
      chartInstance->c3_tp_DECREMENT = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
      chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_RETURN;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
      chartInstance->c3_tp_RETURN = 1U;
     ...
     case c3_IN_RETURN:
      ...
      chartInstance->c3_tp_RETURN = 0U;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
      chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_Sample_and_call;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
      chartInstance->c3_tp_Sample_and_call = 1U;
  ...
  if (c3_out) {
    ...
    if (c3_b_out) {
      ...
      if (c3_c_out) {
        ...
        chartInstance->c3_tp_Sample_and_call = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_DECREMENT;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_DECREMENT = 1U;
        ...
        *c3_v_ref -= *c3_deltaD;
        ...
        chartInstance->c3_tp_Sample_and_call = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_G24i_buck_boost = c3_IN_INCREMENT;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_INCREMENT = 1U;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_G24i_buck_boostInstanceStruct *chartInstance;
  chartInstance = (SFc3_G24i_buck_boostInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_G24i_buck_boost_get_eml_resolved_functions_info(void)
{
...
void sf_c3_G24i_buck_boost_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_G24i_buck_boost_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_G24i_buck_boost_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_G24i_buck_boost_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_G24i_buck_boost(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[24],T\"v_ref\",},{M[3],M[26],T\"I_prev1\",},{M[3],M[27],T\"V_REF\",},{M[3],M[25],T\"V_prev1\",},{M[3],M[29],T\"deltaI\",},{M[3],M[28],T\"deltaV\",},{M[8],M[0],T\"is_active_c3_G24i_buck_boost\",},{M[9],M[0],T\"is_c3_G24i_buck_boost\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_G24i_buck_boost_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_G24i_buck_boostInstanceStruct *)
...
static void sf_opaque_initialize_c3_G24i_buck_boost(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
  initialize_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_G24i_buck_boost(void *chartInstanceVar)
{
  enable_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_G24i_buck_boost(void *chartInstanceVar)
{
  disable_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_G24i_buck_boost(void *chartInstanceVar)
{
  sf_gateway_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_G24i_buck_boost(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_G24i_buck_boost
    ((SFc3_G24i_buck_boostInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_G24i_buck_boost();/* state var info */
...
extern void sf_internal_set_sim_state_c3_G24i_buck_boost(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_G24i_buck_boost();/* state var info */
  ...
  set_sim_state_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_G24i_buck_boost(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_G24i_buck_boost(S);
}

static void sf_opaque_set_sim_state_c3_G24i_buck_boost(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_G24i_buck_boost(S, st);
}

static void sf_opaque_terminate_c3_G24i_buck_boost(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_G24i_buck_boostInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_G24i_buck_boost((SFc3_G24i_buck_boostInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_G24i_buck_boost(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_G24i_buck_boost(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_G24i_buck_boost(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_G24i_buck_boost(SimStruct *S)
{
  SFc3_G24i_buck_boostInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_G24i_buck_boostInstanceStruct *)utMalloc(sizeof
    (SFc3_G24i_buck_boostInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_G24i_buck_boostInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_G24i_buck_boost;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_G24i_buck_boost;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_G24i_buck_boost;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_G24i_buck_boost;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_G24i_buck_boost;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_G24i_buck_boost;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_G24i_buck_boost;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_G24i_buck_boost;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_G24i_buck_boost;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_G24i_buck_boost;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_G24i_buck_boost;
...
void c3_G24i_buck_boost_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_G24i_buck_boost(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_G24i_buck_boost(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_G24i_buck_boost(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_G24i_buck_boost_method_dispatcher.\n"
